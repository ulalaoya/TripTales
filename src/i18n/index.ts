...
export const STRINGS = {
  he: {
    ...
    tripIconLabel: 'סוג הטיול',
    generalPhotos: 'כללי',
    reactLabel: 'הגיבו',
    coverPhotoLabel: 'תמונת שער',
    paletteLabel: 'ערכת צבעים',
    ...
    lightMode: 'מצב יום',
    appearance: 'תצוגה',
    syncDiagnostics: 'אבחון סנכרון',
    syncDiagState: 'מצב',
    syncDiagDevice: 'מזהה מכשיר',
    syncDiagLastPush: 'שליחה אחרונה',
    syncDiagLastPull: 'קבלה אחרונה',
    syncDiagError: 'שגיאה',
    syncDiagActivities: 'פעילויות',
    syncDiagInCloud: 'בענן',
    syncDiagSubscribed: 'מחובר',
    syncDiagCopy: 'העתקת נתוני האבחון',
    ...
    backupExport: 'שמירת גיבוי לקובץ',
    backupImport: 'שחזור מקובץ',
    backupDone: 'הגיבוי נשמר',
    backupNothing: 'אין עדיין מה לגבות',
    backupBadFile: 'הקובץ אינו גיבוי תקין של TripTales',
    backupConfirm: 'השחזור יחליף את כל מה שנמצא כרגע במכשיר. הגיבוי הנוכחי יישמר אוטומטית לפני כן. להמשיך?',
    backupRestored: 'השחזור הושלם. טוען מחדש…',
    backupAuto: 'גיבויים אוטומטיים במכשיר',
    backupAutoEmpty: 'עדיין אין גיבויים אוטומטיים',
    backupRestoreThis: 'שחזור',
    backupSummary: '{trips} טיולים · {activities} פעילויות · {photos} תמונות',
    backupExplain: 'המכשיר שומר עותק לפני כל סנכרון. הקובץ נשמר אצלך ולא נשלח לשום מקום.',
    // ----- photo delete (Item 3) -----
  ...
  en: {
    ...
    syncDiagState: 'State',
    syncDiagDevice: 'Device id',
    syncDiagLastPush: 'Last push',
    syncDiagLastPull: 'Last pull',
    syncDiagError: 'Error',
    syncDiagActivities: 'Activities',
    syncDiagInCloud: 'in cloud',
    syncDiagSubscribed: 'subscribed',
    syncDiagCopy: 'Copy diagnostics',
    ...
    backupImport: 'Restore from a file',
    backupDone: 'Backup saved',
    backupNothing: 'Nothing to back up yet',
    backupBadFile: 'That file is not a valid TripTales backup',
    backupConfirm: 'Restoring replaces everything currently on this device. The current state is backed up automatically first. Continue?',
    backupRestored: 'Restored. Reloading…',
    backupAuto: 'Automatic backups on this device',
    backupAutoEmpty: 'No automatic backups yet',
    backupRestoreThis: 'Restore',
    backupSummary: '{trips} trips · {activities} activities · {photos} photos',
    backupExplain: 'This device saves a copy before every sync. The file stays with you and is never uploaded.',
    // ----- photo delete (Item 3) -----
